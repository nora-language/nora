...
type SumType struct {
	...
	IsPrimitiveEnum bool              // Extracted from [repr("type")]
	PrimitiveType   NRType            // The backing integer type for PrimitiveEnum
}
...
type Variant struct {
	...
	Value      int64             // Extracted integer value (if IsPrimitiveEnum is true)
}
...
func (s *SumType) Size() int {
	if s.IsPrimitiveEnum && s.PrimitiveType != nil {
		return s.PrimitiveType.Size()
	}
