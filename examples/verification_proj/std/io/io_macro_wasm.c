...
const char* get_fmt_spec(const char* type_name, const char* value_raw) {
    ...
    if (strcmp(type_name, "i8") == 0 || strcmp(type_name, "i16") == 0 || strcmp(type_name, "i32") == 0 || strcmp(type_name, "int") == 0) return "%d";
    if (strcmp(type_name, "ptr") == 0) return "%p";
    if (strcmp(type_name, "u8") == 0 || strcmp(type_name, "u16") == 0 || strcmp(type_name, "u32") == 0) return "%u";
    if (strcmp(type_name, "i64") == 0) return "%lld";
    if (strcmp(type_name, "u64") == 0) return "%llu";
    if (strcmp(type_name, "f32") == 0) return "%f";
    if (strcmp(type_name, "f64") == 0) return "%lf";
    if (strcmp(type_name, "bool") == 0) return "%s";
    // Default: string
    return "%s";
}
...
char* build_scanf(char* request, bool scanln) {
    ...
    while (1) {
        ...
        bool is_ptr = (type_name[0] == '*' || strcmp(type_name, "ptr") == 0);
